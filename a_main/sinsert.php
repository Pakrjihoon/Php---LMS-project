...
$sql = "INSERT INTO Student(stu_num, stu_name, stu_grade, stu_major_name, stu_prof_num, stu_gender)
 VALUES ('$_POST[s_number]', '$_POST[s_name]', '$_POST[s_grade]', '$_POST[s_major]', '$_POST[s_level]', '$_POST[s_gender]')";

if ($conn->query($sql) === TRUE) {
    echo "<script>alert(\"정상적으로 추가 완료\");</script>";
} else {
