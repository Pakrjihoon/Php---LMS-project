...
$sql = "update Student set stu_num = '$_POST[s_number]', stu_name = '$_POST[s_name]', stu_grade = '$_POST[s_grade]', stu_major_name = '$_POST[s_major]', stu_prof_num = '$_POST[s_level]', stu_gender = '$_POST[s_gender]' where stu_num = '$_POST[s_number]'";
