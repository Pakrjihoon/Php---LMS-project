...
$list2 = $_POST['counsel']; //학번
$list1 = $_POST['stunum'];
date_default_timezone_set("Asia/Seoul");
$today1 = date("Y년m월d일 H시 i분 s초");
echo $today1;

$sql = "insert into Meeting(m_stu_num, m_date, m_contents) values ('$list1', '$today1', '$list2')";
