				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
							<header id="header">
								<a href="p_input.php" class="logo">성적 입력(정정 및 조회)</a>
								<ul class="action">
...
if ($conn->connect_error) {
 ...
 $sql="select a.stu_num, a.stu_name, c.sub_name, b.sg_grade, b.sg_osu_num from Student_view a, Sugang_view b, Subject_view c, Opensubject_view d 
where a.stu_num = b.sg_stu_num and b.sg_approval = 'Y' and d.osu_make_num = b.sg_osu_num and c.sub_num = d.osu_sub_num and d.osu_prof_num = '$prof_numbers'";     // SELECT 구문을 통해 테이블 가져옴
    ...
    for($i=0; $i<$numrow; $i++){                 //행(ROW) 수 만큼 
     ...
     echo "<font size=5 color=#3d4449><b>성적 입력, 조회</b></font><br>
    <table border = 1>
    <tr> 
    ...
    <td width=150 height=30  align=center><b>성적입력</td>
    </tr>
    </table>";
...
<table border = 1>
        ...
        <tr>
            ...
            <td colspan=2 width=250 height=30  align=center><input type=\"text\" name = \"use[]\"value = \"\"></td>	
            <input type=\"hidden\" name = \"user[]\" value = \"$sNum[$i]\">
            <input type=\"hidden\" name = \"users[]\" value = \"$sgOsu[$i]\">
         </tr>
</table>
            ";
    }
echo "<p align = \"center\">";
echo "<input type = \"button\" value = \"성적입력\" onclick = \"sendData('send');\">";
$conn->close();
?>
