...
<html>
	...
	<body>
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
							<header id="header">
								<a href="p_search.php" class="logo">지도학생 정보조회</a>
								<ul class="action">
		...
		<form action="#" method="POST">
            ...
            <input type="submit" name = "submit2" value="전체조회"/>
        </form>
        <?php
...
if(isset($_POST['submit2'])){
	$sql = "select * from Student_view where stu_prof_num = '$prof_numbers'";
...
if(isset($_POST['submit'])){
	...
	if(isset($_POST['grade']) & $check_gender == "성별선택"){
		$sql = "select * from Student_view where stu_grade = '$check_grade' and stu_prof_num = '$prof_numbers'";
...
<table border = 1>
	...
	if(isset($_POST['gender']) && $check_grade == 0){
		$sql = "select * from Student_view where stu_gender = '$check_gender' and stu_prof_num = '$prof_numbers' order by stu_grade";
	$result=mysqli_query($conn,$sql);
    $numrow = mysqli_num_rows($result);   //총 몇 개의 행을 불러왔는지 확인
...
<table border = 1>
	...
	if(isset($_POST['gender']) & isset($_POST['grade'])){
		$sql = "select * from Student_view where stu_grade = '$check_grade' and stu_gender = '$check_gender' and stu_prof_num = '$prof_numbers'";
	$result=mysqli_query($conn,$sql);
    $numrow = mysqli_num_rows($result);   //총 몇 개의 행을 불러왔는지 확인
